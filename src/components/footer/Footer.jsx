          ...
          <div className="footer__contacts">
            ...
            <div className="contacts__block">
              <div className="commercial">
                <h3 className="contacts__title">Коммерційний відділ</h3>
                <span className="commercial__number">050 -370-37-81</span>{" "}
                <br />
                <span className="commercial__number">050 -430-86-61</span>
              </div>
              <div className="clients">
                <h3 className="contacts__title">
                  Відділ по роботі з клієнтами
                </h3>
                <span className="clients__number">050 -334-82-00</span>
              </div>
            </div>
          </div>
        </div>
